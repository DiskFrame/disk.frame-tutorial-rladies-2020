...
You can do that with `map` and `write_disk.frame`. E.g.
...
```{r}
flights_w_flight_date.df %>% 
  write_disk.frame(outdir = "some_model.df")
```
...
If we still have time we go through, how to define your own one-stage group-by functions
